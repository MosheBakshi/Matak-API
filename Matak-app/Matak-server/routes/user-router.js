...
router.put('/users',Validations.verifyUser, Permissions.isAdmin, UserCtrl.updateUser)
router.delete('/users',Validations.verifyUser, Permissions.isAdmin, UserCtrl.deleteUser)
